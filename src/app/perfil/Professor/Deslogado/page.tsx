      ...
      <div className="w-full h-screen max-w-[40%] mx-auto bg-white rounded shadow-md">
        <div className="bg-customGreen border-b rounded-t">
          <div className="flex items-center p-5">
            <Image
              ...
              width={120}
              height={120}
              className="w-32 h-32 rounded-full shadow-md z-10 object-cover bg-white"
            />
          </div>
          ...
          <div className="w-full h-40 bg-white p-4">
            <div className="flex flex-col">
              <div className="flex flex-col w-full p-4 ml-4">
                <h1 className="text-xl font-bold text-black mb-1.5">Felipe Luis</h1>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-sm text-gray-700 mb-1.5">Estrutura de Dados, Introdução a Técnico de Futebol, Cálculo 3</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-3 p-4">
          ...
          <div className="bg-customGreen rounded-lg shadow mb-4 flex flex-row p-3 ">
            ...
            <div className="max-w-[550px]">
              ...
              <p className="text-sm text-gray-500">
                17/04/2024, às 21:42 - Felipe Luis: Estrutura de Dados
              </p>
          ...
          <div className="bg-customGreen rounded-lg shadow mb-4 flex p-3 ">
            ...
            <div className="max-w-[550px]">
              <p className="font-bold text-gray-800">Gabriel Barbosa</p>
              <p className="text-sm text-gray-500">
